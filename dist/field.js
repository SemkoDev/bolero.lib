...
var LoggedField = function (_FieldBase) {
  ...
  function LoggedField() {
    ...
    return _possibleConstructorReturn(this, (LoggedField.__proto__ || Object.getPrototypeOf(LoggedField)).apply(this, arguments));
  }
  ...
  _createClass(LoggedField, [{
    ...
    value: function log() {
      ...
      onMessage(Array.from(arguments).map(function (a) {
        return (typeof a === 'undefined' ? 'undefined' : _typeof(a)) === 'object' ? JSON.stringify(a) : a.toString();
      }).join(' '));
    }
  }]);
